...
def compare_models(prompt: str) -> dict:
    ...
    gpt4o_cost_estimate = (len(gpt4o_answer.split()) / 0.75) / 1000 * PRICING_PER_1K_TOKENS["gpt-4o"]["output"]
    return {
...
def run_assistant(
    ...
    while True:
        ...
        # Chỉ giữ 4 lượt hội thoại gần nhất (8 messages)
        history = history[-8:]
